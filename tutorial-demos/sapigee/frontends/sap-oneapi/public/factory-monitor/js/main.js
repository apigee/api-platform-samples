...
jQuery(document).ready(function($) {
   ...
   var imageType = "";
	 ...
	 var functionsBaseUrl = "https://amer-partner3-prod.apigee.net/factory";
 ...
 //   img.src = URL.createObjectURL(this.files[0]);
   ...
   function callSecurityVisionService() {
		...
		if (document.getElementById("offline-switch").checked) {
			...
			$.ajax({
				...
				url: url,
				headers: {
					"x-apikey": "otJblojLlLWveip7Bc1Y4PAPce0GHlSz",
   ...
   function getUrlVars() {
	...
	function checkMeter() {
		$.ajax({
			type: "GET",
			url: functionsBaseUrl + "/machines/" + checkpointId,
			headers: {
					"x-apikey": "otJblojLlLWveip7Bc1Y4PAPce0GHlSz",
					"Content-Type": "application/json"
			},
