The apiproxy folder contains the Apigee API Proxy for the OAuth2.0
...
3.    On successful authentication, login application invokes: http://{org_name}-{env_name}.apigee.net/oauth/authorizationcode?client_id=EOGjx792Vq6lK8D9ATr7Vf5cZ1UHbc9k&response_type=code&userId=Sandeep
This is something that the login page should do. The sample login page in the above example does that
