...
echo -e "\n\nAPI 1 of 2: http://$org-$env.$api_domain/parse-request-url/extract-variables/resource1/123456"
read -p "Press Return to call this API..."
curl "http://$org-$env.$api_domain/parse-request-url/extract-variables/resource1/123456" 
echo -e "\n\nAPI 2 of 2: http://$org-$env.$api_domain/parse-request-url/extract-variables?code=abc123"
read -p "Press Return to call this API..."
